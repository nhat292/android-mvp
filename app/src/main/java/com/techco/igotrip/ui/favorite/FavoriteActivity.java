...
public class FavoriteActivity extends BaseActivity implements FavoriteBaseView, PermissionResultListener, ArticleActionCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter.onAttach(FavoriteActivity.this);
    ...
    protected void setUp() {
        txtTitle.setText(getString(R.string.menu_favorites));
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                carouselPagerAdapter = new CarouselPagerAdapter(FavoriteActivity.this, pagerArticle, getSupportFragmentManager(), articles);
    ...
    @Override
    public void onGetFavoritesSuccess(List<Article> articles) {
        this.articles.clear();
    ...
    private void getFavorites() {
        ...
        mPresenter.getFavorites(lat, lng);
    }
    ...
    public void onAddFavoriteClick(int position) {
        this.position = position;
        mPresenter.removeFavorite(articles.get(position).getId());
    }
