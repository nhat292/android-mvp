...
public class FavoritePresenter<V extends FavoriteBaseView> extends BasePresenter<V>
    ...
    @Override
    public void getFavorites(double lat, double lng) {
        ...
        getCompositeDisposable().add(getDataManager()
                ...
                .subscribe(response -> {
                    ...
                    getMvpView().onGetFavoritesSuccess(response.getArticles());
                }, throwable -> {
                    if (!isViewAttached()) {
                        return;
                    }
